...
class InterviewReport(Base):
    ...
    scores: Mapped[Dict[str, Any]] = mapped_column(
        JSON, default=lambda: RadarScore().model_dump()
    )
    ...
    learning_plan_7_days: Mapped[List[Dict[str, Any]]] = mapped_column(
        JSON, default=list
    )
    learning_plan_14_days: Mapped[List[Dict[str, Any]]] = mapped_column(
        JSON, default=list
    )
