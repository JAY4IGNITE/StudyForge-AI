...
from app.services.coding_profile.leetcode_service import (
    fetch_leetcode_stats,
    verify_leetcode_username,
)
from app.services.coding_profile.codeforces_service import (
    fetch_codeforces_stats,
    verify_codeforces_username,
)
from app.services.coding_profile.github_service import (
    fetch_github_stats,
...
async def sync_profile_stats(
    profile: CodingProfile, force: bool = False
) -> CodingProfile:
    """
    ...
    if profile.platforms.codeforces and profile.platforms.codeforces.username:
        tasks["codeforces"] = fetch_codeforces_stats(
            profile.platforms.codeforces.username
        )
