          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">
            {Object.entries(report.scores).map(([key, val]: [string, any]) => (
              <Card key={key} className="p-4 text-center">
                <p className="mb-1 font-mono text-xs capitalize text-muted-foreground">{key.replace('_', ' ')}</p>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <Card className="space-y-3 border-steel/20 bg-steel/5 p-5">
            ...
            <div className="grid grid-cols-3 gap-2 py-2 text-center">
              <div className="rounded-xl bg-card p-2">
                <p className="font-mono text-[10px] text-muted-foreground">Posture score</p>
                <p className="font-mono text-lg font-semibold text-gold">92%</p>
              </div>
              <div className="rounded-xl bg-card p-2">
                <p className="font-mono text-[10px] text-muted-foreground">Eye contact</p>
          ...
          <Card className="space-y-3 border-ember/20 bg-ember/5 p-5">
            ...
            <div className="grid grid-cols-3 gap-2 py-2 text-center">
              ...
              <div className="rounded-xl bg-card p-2">
                <p className="font-mono text-[10px] text-muted-foreground">Speech clarity</p>
