          ...
          >
            ...
            >
              ...
              <div className="text-center">
                <h2 className="text-lg font-semibold tracking-tight text-foreground">Creating Account</h2>
                <p className="text-sm text-secondary mt-1">Setting up your learning workspace...</p>
              </div>
            </motion.div>
          </motion.div>
        )}
        ...
        >
          <motion.div variants={itemVariants} className="mb-6 flex flex-col items-center text-center">
            ...
            <p className="mt-2 max-w-[280px] text-sm text-secondary">
              Create your account to start your adaptive learning journey.
            </p>
          </motion.div>
          ...
          <motion.form variants={itemVariants} onSubmit={handleSubmit} className="space-y-4">
            <div>
              <Label htmlFor="name" className="mb-2 block text-[11px] uppercase tracking-wider text-secondary">
                Full name
              </Label>
              <div className="relative">
                <User className="pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-secondary" />
                <Input
                  id="name"
                  type="text"
                  required
            ...
            <div>
              <Label htmlFor="password" className="mb-2 block text-[11px] uppercase tracking-wider text-secondary">
                Password
              </Label>
              <div className="relative">
          ...
          <motion.p variants={itemVariants} className="mt-6 text-center text-xs text-secondary">
            ...
            <Link to="/login" className="font-medium text-ember hover:text-ember/80 hover:underline">
              Log in
            </Link>
          </motion.p>
        </motion.div>
