  ...
  if (results.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-full bg-card/95 text-center p-8">
        <Terminal className="w-10 h-10 text-secondary/40 mb-3" />
        <h3 className="text-sm font-bold text-secondary mb-1">Console</h3>
      ...
      <div className={`flex items-center gap-3 px-4 py-3 border-b border-border ${statusBg}`}>
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            <p className="text-[10px] text-secondary font-medium">Runtime</p>
          ...
          <div className="text-right">
            <p className="text-[10px] text-secondary font-medium">Score</p>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="text-[10px] text-secondary font-mono mr-2">
                  {r.runtimeMs}ms
                </span>
                {isExpanded ? (
