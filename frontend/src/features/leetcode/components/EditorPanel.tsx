      ...
      <div className="flex items-center justify-between px-3 py-1.5 border-b border-border bg-card/80">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-foreground/85 bg-surface hover:bg-surface/70 rounded-lg transition-colors border border-border/60"
          >
          ...
          {showLangMenu && (
            <div className="absolute top-full left-0 mt-1 bg-surface border border-border rounded-xl shadow-2xl shadow-black/50 overflow-hidden z-50 min-w-[160px]">
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-2 text-xs font-medium transition-colors ${
                    language === lang
                      ...
                      : 'text-foreground/85 hover:bg-surface/70'
                  }`}
                >
        ...
        <div className="flex items-center gap-1.5">
          ...
          <div className="relative">
            ...
            {showSettings && (
              <div className="absolute top-full right-0 mt-1 bg-surface border border-border rounded-xl shadow-2xl shadow-black/50 p-4 z-50 min-w-[200px] space-y-3">
                <div>
          ...
          <button
            onClick={resetCode}
            className="p-1.5 text-muted-foreground hover:text-gold transition-colors rounded-md hover:bg-surface"
      ...
      <div className="flex items-center justify-between px-3 py-2 border-t border-border bg-card/80">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-1.5 text-xs font-bold text-foreground/85 bg-surface hover:bg-surface/70 rounded-lg transition-all disabled:opacity-40 disabled:cursor-not-allowed border border-border/60"
          >
            {isRunning ? (
          ...
          <button
            onClick={submitCode}
            disabled={isRunning || isSubmitting}
            className="flex items-center gap-1.5 px-4 py-1.5 text-xs font-bold text-primary-foreground bg-primary-gradient hover:brightness-110 rounded-lg transition-all disabled:opacity-40 disabled:cursor-not-allowed shadow-lg shadow-ember/20"
          >
            {isSubmitting ? (
              <Loader2 className="w-3.5 h-3.5 animate-spin" />
            ) : (
