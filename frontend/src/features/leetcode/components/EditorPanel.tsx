        ...
        <div className="flex items-center gap-1.5">
          ...
          <div className="relative">
            <button
              ...
              className="p-1.5 text-secondary hover:text-foreground transition-colors rounded-md hover:bg-secondary"
            ...
            {showSettings && (
              <div className="absolute top-full right-0 mt-1 bg-secondary border border-border rounded-xl shadow-2xl shadow-black/50 p-4 z-50 min-w-[200px] space-y-3">
                <div>
                  <label className="text-[10px] font-bold text-secondary uppercase tracking-wider mb-1 block">
                    Font Size
                  </label>
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-xs text-secondary font-mono w-6 text-right">
                      {fontSize}
                    </span>
                  </div>
                </div>
          ...
          <button
            onClick={resetCode}
            className="p-1.5 text-secondary hover:text-gold transition-colors rounded-md hover:bg-secondary"
